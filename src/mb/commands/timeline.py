...
def discover(
    ...
    collection: str = typer.Option(
        None, "--collection", "-c", help="Collection name (e.g. books, music)"
    ),
        ...
        output_or_exit(
            {
                ...
                "data": {
                    ...
                    "collections": list_discover_collections(),
                },
            },
            fmt,
        )
    ...
    if collection and not get_discover_collection(collection):
        ...
        output(
            {
                "ok": False,
                "error": f"Unknown discover collection: {collection}. Use --list to see curated options.",
                "code": 400,
            },
            fmt,
        )
